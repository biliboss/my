//! A ROTA `/empresa`. Ela roteia e compõe, e não decide nada.
//!
//! Tudo que uma pessoa lê nesta página mora em
//! `packages/lp-slices/src/pages/empresa.tsx`; tudo que um robô lê mora em
//! `packages/lp-slices/src/slices/empresa.ts`. A base fica com o que é do Next:
